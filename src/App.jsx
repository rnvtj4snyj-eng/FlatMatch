...
function PostedConfirmation({ onBrowse, onTakeQuiz }) {
  return (
    <div style={styles.introWrap}>
      ...
      <div style={styles.formActions}>
        <button style={styles.primaryBtn} onClick={onTakeQuiz}>
          Take the quiz yourself
        </button>
        <button style={styles.secondaryBtn} onClick={onBrowse}>
          Back to home
        </button>
      </div>
    </div>
...
const styles = {
  ...
  primaryBtn: {
    ...
    borderRadius: 100,
    cursor: "pointer",
    boxShadow: "0 4px 14px rgba(31, 169, 160, 0.35)",
  },
  ...
  feeLabel: { fontFamily: "'Fredoka', sans-serif", fontSize: 17, fontWeight: 600, color: "#23363A" },
  feeAmount: { fontFamily: "'Fredoka', sans-serif", fontSize: 26, fontWeight: 700, color: "#ff6b4a" },
